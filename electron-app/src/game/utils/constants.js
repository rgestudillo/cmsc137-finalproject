export const PLAYER_SPRITE_WIDTH = 64;
...
export const GHOST_SPRITE_WIDTH = 64;
export const GHOST_SPRITE_HEIGHT = 64;
export const GHOST_HEIGHT = 64;
export const GHOST_WIDTH = 64;
export const GHOST_START_X = 330;
export const GHOST_START_Y = 100;
